    ...
    <form method="POST"  enctype="multipart/form-data"  action="<?=base_url('app/control/activity-information/info/').$this->session->userdata('_id')?>">
      <div class="row">
        <div class="col-xl-4 order-xl-2">           
            <div class="card">
                <div class="card-body">             
                <div class="row">
                        <img  id="perincre" width="100%" src="" alt="">
                        
                </div>
                <div class="text-center text-muted mb-4">
                          <small id="name_image_incre"></small>
                      </div>
                <hr class="my-4" /> 
                <div class="form-group text-center">
                            <label class="custom-file-upload">
                                <input type="file" id="cuse_incre_upload" name="image" />
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <textarea rows="6" name="desc_activity" id="desc" class="form-control desc" placeholder="<?=$this->lang->line('desc')?>..."></textarea>
