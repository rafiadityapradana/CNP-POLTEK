          ...
          <div class="card">
            ...
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Users Company Table</h3>
                </div>
            ...
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                <?php foreach($user_allcom as $user):?>
                  <tr>
                  <th scope="row">
                    <?=$user['name']?>
                    </th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">	
                <div class="row text-center">
                  ...
                  <div class="col-md-6">
                  <a href="<?=base_url('app/control/users/data/company/detail/').$user['_id']?>" class="btn btn-sm btn-outline-primary btn-block">Detail</a>
                  </div>
                </div>               
            </div>    
        </div>
