          ...
          <div class="card">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">View User Request</h3>
                </div>
                <!-- -->
              </div>
            </div>
                ...
                <div class="container">
                  <div class="row">
                    ...
                    <div class="col-md-12 mb-4">
                      <a href="<?=base_url('app/control/users/activate-request/').$view['_id']?>" class="btn btn-success btn-sm">Activate</a>
                      <a href="<?=base_url('app/control/users/disable-request/').$view['_id']?>" class="btn btn-danger btn-sm">Disable it</a>
                    </div>
                  </div> 
                </div>
