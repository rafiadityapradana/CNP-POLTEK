          ...
          <div class="card">
            ...
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Users College Student Table</h3>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">	
                <div class="row text-center">
                  ...
                  <div class="col-md-6">
                  <a href="<?=base_url('app/control/users/data/college-students/detail/').$user['_id']?>" class="btn btn-sm btn-outline-primary btn-block">Detail</a>
                  </div>
                </div>               
            </div>    
        </div>
