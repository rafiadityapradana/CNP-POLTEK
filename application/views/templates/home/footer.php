        ...
        <div class="row align-items-center justify-content-lg-between">
          <div class="col-lg-6">
            <div class="copyright text-center  text-lg-left  text-muted">
              &copy; <?=date('Y')?> by <a href="https://www.instagram.com/rafilatip212" class="font-weight-bold ml-1" target="_blank">RafiLatip212</a>
            </div>
          </div>
  ...
  <script src="<?=base_url('assets/private/')?>ck/summernote-lite.js"></script>
  <script src="<?=base_url('assets/private/')?>js/main.js"></script>
</body>
